...
import 'package:venom/src/core/interceptors/request_interceptor.dart' as _i22;
...
import 'package:venom/src/presentation/ride/bloc/ride_result/ride_result_bloc.dart'
    as _i25;
import 'package:venom/src/presentation/ride/bloc/rides/rides_bloc.dart' as _i26;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i14.HomeLocalDataSource>(() => homeFeatureModule.localDS);
    gh.factory<_i15.HomeRemoteDataSource>(() => homeFeatureModule.remoteDS);
    gh.factory<_i16.HomeRepository>(() => homeFeatureModule.repo);
    gh.lazySingleton<_i17.KmInBikeBloc>(() => _i17.KmInBikeBloc());
    gh.lazySingleton<_i18.MyVehicleBloc>(() => _i18.MyVehicleBloc(
          gh<_i12.GetCachedVehicleDataUseCase>(),
          gh<_i6.CacheVehicleDataUseCase>(),
        ));
    gh.lazySingleton<_i19.NewRideBloc>(() => _i19.NewRideBloc());
    gh.factory<_i20.PriceLocalDataSource>(() => priceFeatureModule.localDS);
    gh.factory<_i21.PriceRepository>(() => priceFeatureModule.repo);
    gh.factory<_i22.RequestInterceptor>(() => _i22.RequestInterceptor());
    gh.factory<_i23.RideLocalDataSource>(() => rideFeatureModule.localDS);
    gh.factory<_i24.RideRepository>(() => rideFeatureModule.repo);
    gh.lazySingleton<_i25.RideResultBloc>(() => _i25.RideResultBloc(
          gh<_i5.CacheRideDataUseCase>(),
          gh<_i11.GetCachedRideDataUseCase>(),
        ));
    gh.lazySingleton<_i26.RidesBloc>(() => _i26.RidesBloc(
          gh<_i11.GetCachedRideDataUseCase>(),
          gh<_i5.CacheRideDataUseCase>(),
        ));
    gh.factory<_i27.VehicleLocalDataSource>(() => vehicleFeatureModule.localDS);
    gh.factory<_i28.VehicleRepository>(() => vehicleFeatureModule.repo);
    gh.lazySingleton<_i29.GasPriceBloc>(() => _i29.GasPriceBloc(
...
class _$HomeFeatureModule extends _i30.HomeFeatureModule {}

class _$PriceFeatureModule extends _i31.PriceFeatureModule {}

class _$RideFeatureModule extends _i32.RideFeatureModule {}

class _$VehicleFeatureModule extends _i33.VehicleFeatureModule {}
